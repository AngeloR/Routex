...
class Route {
	 ...
	 * 
	 * @var array $supportedVerbs a list of HTTP Verbs that we are supporting within the application
	 */
	 ...
	 * 
	 * @var string $httpVerb the HTTP Verb (get/post/put etc.) that this route pertains to
	 * @var string $route the route that the user set
	 * @var callable $callback the callback that is executed when the route is matched
	 */
	 ...
	 * 
	 * @var string $httpVerb the HTTP Verb (get/post/put etc.) that we are accessing with
	 * @var string $uri the endpoint that we are trying to access
	 * @var HTTPRequest &$req a reference to our HttpRequest object
	 * 
	 ...
	 * 
	 * @var string $uri the endpoint that we are trying to access
	 * @var \Routex\Route\Path $path the path object that matches the endpoint
	 * 
	 * @return see mapArgs
	 */
	 ...
	 *
	 * @var \Routex\Route\Path $path the path object that matches the endpoint
	 * @var $values a list of the values of all variable elements within the route
	 *
	 ...
	 * 
	 * @var string $route the endpoint that you want to handle
	 * @var callable $callback the callback that you want to execute
	 */
